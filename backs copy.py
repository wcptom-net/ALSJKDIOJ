...
API_KEY = "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"
client = OpenAI(
...
def create_ppt_from_outline(outline, output_path, color):
    """Create a PowerPoint presentation from an outline with a specific color and enhanced theme."""
    prs = Presentation()
    ...
    title_frame.paragraphs[0].font.bold = True  # 設定加粗
    title_frame.paragraphs[0].font.size = Pt(36)  # 設定字體大小
    ...
    for section in outline.split("\n\n"):
        ...
        if lines:
            ...
            slide_title.text_frame.paragraphs[0].font.bold = True  # 設定加粗
            slide_title.text_frame.paragraphs[0].font.size = Pt(28)  # 設定字體大小
            ...
            for paragraph in textbox.text_frame.paragraphs:
                ...
                paragraph.font.size = Pt(20)  # 設定字體大小
...
class MainWindow(QMainWindow):
    ...
    def generate_ppt(self):
        ...
        color_map = {
            0: RGBColor(255, 0, 0),     # 紅色
            1: RGBColor(0, 0, 255),     # 藍色
            2: RGBColor(0, 255, 0),     # 綠色
            3: RGBColor(255, 255, 0),   # 黃色
            4: RGBColor(128, 0, 128),   # 紫色
            5: RGBColor(255, 165, 0),   # 橙色
            6: RGBColor(128, 128, 128), # 灰色
            7: RGBColor(255, 192, 203)  # 粉紅色
        }
